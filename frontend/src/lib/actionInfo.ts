...
export const HUB_ACTION_INFO: Record<HubActionKey, ActionInfo> = {
  ...
  betray: {
    ...
    points: '+150 BP (tú) · −30 BP (víctima)',
  ...
  bribe: {
    ...
    points: '50–500 BP según la hora',
  ...
  challenge: {
    ...
    points: 'Ganas: +75 BP · Pierdes: +10 BP',
    rules: ['1 desafío por día', 'Si ganas, tu rival pierde −15 BP', 'Ideal para rivalidades del grupo']
  },
  arena: {
    emoji: '🎮',
    title: 'Arena Beast',
...
export const GAME_ACTION_INFO: Record<GameActionKey, ActionInfo> = {
  redlight: {
    ...
    points: 'Ganas: +80 BP · Pierdes: −20 BP',
  ...
  ddakji: {
    ...
    points: 'Ganas: +90 BP · Pierdes: +15 BP',
  ...
  glass: {
    ...
    points: 'Hasta +200 BP (25 BP por paso)',
  ...
  honeycomb: {
    ...
    points: 'Según precisión (hasta ~120 BP)',
    rules: ['1 partida por día', 'Más precisión = más BP', 'Inspirado en Squid Game']
  },
  mystery: {
    emoji: '🎁',
    title: 'Caja Misteriosa',
    description: 'Elige 1 de 3 cajas. Solo una tiene el premio grande — las otras dan migajas.',
    points: 'Acierto: +120 BP · Fallo: +5 BP',
  ...
  tug: {
    ...
    points: 'Hasta +150 BP',
    rules: ['1 partida por día', '10 segundos de frenesí', 'Más taps = más BP']
  }
};
